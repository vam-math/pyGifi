...
def gifi_engine(gifi, ndim, itmax=1000, eps=1e-6, verbose=False, init_x=None, r_seed=None):
    ...
    while True:
        ...
        for i, gifi_set in enumerate(gifi):
            ...
            # ── Majorization step: follows gifiEngine.R behavior closely ──────────
            #
            ...
            # ensures each variable sees the same step-size bound, as in R.
            #
        ...
        # Convergence check (same rule as R: itel > 1 required)
