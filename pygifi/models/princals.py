...
class Princals(BaseEstimator, TransformerMixin):  # type: ignore
    ...
    normobj_z : bool, default=True
        Scale objectscores by sqrt(nobs) to keep output aligned with R.
    ...
    def fit(self, X: Union[pd.DataFrame, Any],
        ...
        # This follows R's corList behavior for unit-normalized variables.
        ...
        # call_ follows R's match.call(): stores constructor args as string
        call_str = (
    ...
    def transform(self, X: Any, y: Any = None) -> Any:
        ...
        Out-of-sample projection is not supported, which is also true in R.
    ...
    def summary(self) -> None:
        """Print extended summary in the style of R's summary.princals()."""
        check_is_fitted(self, 'is_fitted_')
        print(repr(self))
        print("\nComponent Loadings:")
